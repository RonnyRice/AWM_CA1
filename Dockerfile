...
MAINTAINER Ron Trevor Liquit
ENV PYTHONUNBUFFERED 1
ENV DJANGO_SETTINGS_MODULE=geoDjangoProject.settings
...
RUN conda env create -n geoDjangoProject --file ENV.yml
# Make RUN commands use the new environment
# See https://pythonspeed.com/articles/activate-conda-dockerfile/ for explanation
RUN echo "conda activate geoDjangoProject" >> ~/.bashrc
